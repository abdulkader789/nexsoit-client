  ...
  return (
    <div className="mb-20">
      <div className="bg-[url('./bg-specialist.jpg')] max-w-full bg-no-repeat bg-cover bg-center bg-blend-multiply bg-black/70">
        <div className="max-w-5xl mx-auto flex justify-center items-center flex-wrap pt-14 pb-20">
          <div className="flex-1 text-white basis-[40%]">
            ...
            <button className="uppercase font-bold text-sm mt-6 px-5 py-2 border border-solid border-white rounded">
              Book a consultation
            </button>
          </div>
          <div className="flex-1 basis-[60%] relative">
            <div className="grid grid-cols-2 text-center uppercase text-white tracking-wide">
              <p className="flex flex-col w-[200px] mx-auto mb-8">
              ...
              <p className="flex flex-col w-[200px] mx-auto">
            ...
            <div className="flex gap-4 items-center p-5 max-w-[500px] bg-[#98BF5A] rounded-md absolute mt-7 left-16">
              <img
