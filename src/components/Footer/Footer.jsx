            ...
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-500">
                  Be the first to know about breaking news, top stories, and
                  insightful articles from around the world.
                </p>
              </div>
            </div>
              ...
              <form className="w-full">
                ...
                <div className="border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                  <input
                    ...
                    className="w-full outline-none border-transparent focus:border-none focus:ring-transparent sm:text-sm"
                  />
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500">
              &copy; 2024. NEXSOIT. All rights reserved.
            </p>
